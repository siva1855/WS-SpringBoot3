...
@EnableJpaRepositories(entityManagerFactoryRef = "mySqlEntityManagerFactory",
              ...
              basePackages = "siva.bootjparepo.multipledb.repository.ProductRepository")
public class MySqlDBConfig {
	...
	public LocalContainerEntityManagerFactoryBean mySqlEntityManagerFactory(
		...
		return entityManagerFactoryBuilder.dataSource(mySqlDataSource())
				.packages("siva.bootjparepo.multipledb.bean.Product")
				.properties(properties)
				.persistenceUnit("spring.datasource1")
				.build();
